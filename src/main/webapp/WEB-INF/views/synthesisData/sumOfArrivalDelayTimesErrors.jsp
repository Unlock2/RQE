			...
			<div class="contents">
				...
				<div style="margin-bottom: 25px">
					<table id="tbl-arrival-delay" style="border-style: none;">
						<thead>
							<tr>
								<th style="background-color: #e6e6ff;"><b>도착 지연 시간 집계</b></th>
								<th colspan="6"
				...
				<div>
					<table id="tbl-arrival-schedule" style="border-style: none;">
						<thead>
							<tr>
								<th colspan="2" style="background-color: #e6e6ff;"><b>도착 예정 시간
									오차</b></th>
								<th colspan="6"
									style="background-color: white; border-style: none"></th>
							</tr>
	...
	*/
	...
	$.fn.serializeObject = function() {
	   ...
	   notFoundResult = function() {
	    	 $('#tbl-arrival-delay > tbody').append('<tr><td colspan="8">검색된 값이 없습니다.</td></tr>');
	    	 $('#tbl-arrival-schedule > tbody').append('<tr><td colspan="8">검색된 값이 없습니다.</td></tr>');
	     };    
