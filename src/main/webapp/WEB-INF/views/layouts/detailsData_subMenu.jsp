...
<section id="container">
	<nav id="snb">
		...
		<ul>
			...
			<c:choose>
				<c:when
					test="${sub_Control eq 'detailsData_bmtIdReferenceSpeedAnalysis'}">
					<li class="active"><a
						href="/detailsData/bmtIdReferenceSpeedAnalysis">BMT ID 기준 속도
							분석</a></li>
				</c:when>
				<c:otherwise>
					<li class=""><a href="/detailsData/bmtIdReferenceSpeedAnalysis">BMT
							ID 기준 속도 분석</a></li>
				</c:otherwise>
			</c:choose>
