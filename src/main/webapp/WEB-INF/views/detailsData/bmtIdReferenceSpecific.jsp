...
<body>
			...
			<!-- tit-page -->	
				<!-- .contents -->
	               <div class="contents" width=100%>
	               	...
	               	<div class="row">
	                	<!-- table -->               
	                    <div style="display: inline-block;vertical-align : top;width: 350px;margin-right: 30px;overflow: scroll;height: 690px">
	                    	<table id="tbl-specific-list">
	                            <thead style="background-color: #e6f2ff">                               
	                                <tr>
	                                    <th style="height: 25PX; width: 80px">BMT ID</th>
	                                    <th style="height: 25PX; width: 60px">No</th>
	                    ...
	                    <!-- \table -->    
	                    <!-- table -->
	                    <div style="display: inline-block;margin-bottom: 20px;width: 1150px;">
	...
	<div id="myModal" class="modal" style="margin-top:80px;">
		...
		<img class="modal-content-img" id="modal_img" style="transform: rotate(180deg); transform-origin: 50% 50% 0px;">
	</div>
</body>
<!-- 사진회전기능 추가 -->
