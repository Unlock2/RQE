...
<!-- 					</p> -->
	...
	<!-- /#container -->
	<div style="margin-left: 240px; margin-right: 250px; text-align: center; margin-bottom: 30px; margin-top: 40px;">
		<input style=" float:left; width: 34px; height: 29px;" type="button" id="prevBtn" value="<<">
...
<!-- 				<div id="calendar_head"></div> -->
			...
			<tbody>
				<tr>
					<td id="calendar_1"
						style="width: 300px; height: 350px; padding: 5px"></td>
					<td id="calendar_2"
						style="width: 300px; height: 350px; padding: 5px"></td>
					<td id="calendar_3"
						style="width: 300px; height: 350px; padding: 5px"></td>
