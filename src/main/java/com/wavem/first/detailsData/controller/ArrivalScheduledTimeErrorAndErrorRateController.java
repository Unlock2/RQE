...
public class ArrivalScheduledTimeErrorAndErrorRateController {
	...
	public ModelAndView getArrivalScheduledTimeErrorAndErrorRate(HttpServletRequest request, HttpServletResponse response, HttpSession session) {
	...
	public ModelAndView getArrivalScheduledTimeErrorAndErrorRateData(HttpServletRequest request, HttpSession session) {
		...
		List<Map<String, Object>> graph = arrivalScheduledTimeErrorAndErrorRateService.getArrivalScheduledTimeErrorAndErrorRateGraphData(map);
