...
<!-- 		<div class="row"> -->
<!-- 			<div class="day" -->
<!-- 				style="padding: 0px 3px 0px 10px; display: inline-block; vertical-align: top; margin-left: 20%;"> -->
<!-- 				<span style="display: table;"><b>요일특성</b></span> <br> <label -->
<!-- 					style="display: table; margin-bottom: 30%;"> <input -->
...
<!-- 			</div> -->
<!-- 			<div class="timecheck" -->
<!-- 				style="padding: 0px 0px 0px 100px; display: inline-block; vertical-align: top; margin-left: 10%;"> -->
<!-- 				<span style="display: table; padding: 0px 0px 10px 0px;"><b style="margin-left: 50px;">시간대특성</b></span> -->
...
<!-- 						</label> <label style="display: table; margin-bottom: 5px;"> <input -->
...
<!-- 						</label> -->
<!-- 					</div> -->
<!-- 					<div style="padding: 0px 100px 0px 20px; display: inline-block; margin-left: 30px;"> -->
<!-- 						<label style="display: table; margin-bottom: 7px;"> <input -->
...
<!-- 				<span style="display: table; padding: 0px 0px 10px 0px; width: 100px"><b style="margin-left: 50%; width: 100px">거리특성</b></span> -->
<!-- 				<label style="display: table; margin-bottom: 7px;"> <input -->
<!-- 					type="checkbox" id="shortest_distance" name="shortest_distance" -->
<!-- 					value="shortest_distance" disabled> 초 단거리 -->
<!-- 				</label> <label style="display: table; margin-bottom: 7px;"> <input -->
<!-- 					type="checkbox" id="short_distance" name="short_distance" -->
<!-- 					value="short_distance" disabled> 중거리 -->
<!-- 				</label> <label style="display: table; margin-bottom: 7px;"> <input -->
<!-- 					type="checkbox" id="medium_distance" name="medium_distance" -->
<!-- 					value="medium_distance" disabled> 초 장거리 -->
<!-- 				</label> -->
<!-- 			</div> -->
<!-- 			<div style="padding: 0px 0px 0px 20px; display: inline-block; margin-top: 25px;"> -->
<!-- 				<label style="display: table; margin-bottom: 7px;"> <input -->
<!-- 					type="checkbox" id="long_distance" name="long_distance" -->
<!-- 					value="long_distance" disabled> 단거리 -->
<!-- 				</label> <label style="display: table; margin-bottom: 7px;"> <input -->
<!-- 					type="checkbox" id="longest_distance" name="longest_distance" -->
<!-- 					value="longest_distance" disabled> 장거리 -->
<!-- 				</label> -->
<!-- 			</div> -->
<!-- 		</div> -->
<!-- 	</form> -->
...
<div class="search" style="height:155px;">
	<form id="search-bmt" >
		<div class="row" style="margin-bottom: 20px; text-align: center;">
			<span class="pd">시작 날짜</span> <input type="text" class="text date"
				id="bmt-start-date" name="bmt-start-date" /> <span class="pd">~</span>
		...
		<div class="row">
			<div class="day"
				style="padding: 0px 3px 0px 10px; display: inline-block; vertical-align: top; margin-left:50px">
				<span style="display: table; margin-left:25px"><b>요일특성</b></span> <br> <label
					style="display: table; margin-bottom: 30%; float:left"> <input
					type="checkbox" id="weekday" name="weekday" value="weekday">주중
				</label> <label style="float:left; margin-left : 20px"> <input type="checkbox" id="weekend" name="weekend"
					value="weekend">주말
				</label>
			</div>
			
			<div class="timecheck"
				style="padding: 0px 0px 0px 10px; display: inline-block; vertical-align: top; margin-left:150px;">
				<span style="display: table; padding: 0px 0px 10px 0px;"><b style="margin-left: 315px;">시간대특성</b></span>
				<div class="row timecheck">
					<div style="display: inline-block; padding-top:5px;">
						<label style="display: table; margin-bottom: 7px; float: left"> <input
							type="checkbox" id="am_peak" name="am_peak" value="am_peak"
							class="weekday" disabled>오전 첨두 (주중)
						</label> 
						
						<label style="display: table; margin-bottom: 5px; float: left; margin-left:20px"> <input
							type="checkbox" id="pm_peak" name="pm_peak" value="pm_peak"
							class="weekday" disabled>오후 첨두 (주중)
						</label> 
						
						<label> <input style="margin-left:20px" type="checkbox" id="am" name="am"
							value="am" class="weekend" disabled>오전 (주말)
						</label>
						
						<label style="display: table; margin-bottom: 7px; float: left; margin-left:20px"> <input
							type="checkbox" id="am_non_peak" name="am_non_peak"
							value="am_non_peak" class="weekday" disabled>오전 비첨두 (주중)
						</label> 
						
						<label style="display: table; margin-bottom: 5px; float: left; margin-left:20px"> <input
							type="checkbox" id="pm_non_peak" name="pm_non_peak"
							value="pm_non_peak" class="weekday" disabled> 오후 비첨두 (주중)
						</label> 
						
						<label> <input style="margin-left:20px" type="checkbox" id="pm" name="pm"
							value="pm" class="weekend" disabled>오후 (주말)
						</label>
					</div>
				</div>
			</div>
			<div class="distance"
				style="display: inline-block; vertical-align: top; margin-left: 150px;">
				<span style="display: table; padding: 0px 0px 10px 0px; margin-left:160px"><b>거리특성</b></span>
				<label style="display: table; margin-bottom: 7px; float:left"> <input
					type="checkbox" id="shortest_distance" name="shortest_distance"
					value="shortest_distance" disabled> 초 단거리
				</label>
