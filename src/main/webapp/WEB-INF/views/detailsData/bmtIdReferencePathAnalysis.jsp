	                ...
	                <div class="contents" style="width:100%">
	                	...
	                	<div id="resultDiv">
	                		...
	                		<div id="resultMapDiv" style= "position: relative; width:85%; height:900px; z-index:1; float: right;">
	                			<div id="cpResultTableDiv" style="width:210px; position: absolute; z-index: 2; left:1px">
	                				<table style="border:3px dashed; background:white; width:210px;">
	                					<thead>
	                						<tr>
		                						<th style="width:135px">cp명</th>
	                			...
	                			<div id="bmtIdReferencePathAnalysisDiv" style= "position: relative; height:700px; z-index:1; margin-top: 228px;">
