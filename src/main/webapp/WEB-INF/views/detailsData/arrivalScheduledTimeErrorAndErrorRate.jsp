	...
	<div id=wrap>
		...
		<!-- \#header -->
			...
			<section id="contents" style="width: 95%;">
				<div class="tit-page">
					<span>도착 예정 시간 오차 및 오차율</span>
					<ul class="path">
						<li>상세 데이터</li>
						<li>도착 예정 시간 오차 및 오차율</li>
					</ul>
					<!-- .path -->
				</div>
				<!-- tit-page -->	
                ...
                <div class="contents" width=100%>
                	...
                	<!-- /.search -->
                	<!-- .row -->   
                	<div style="margin-bottom: 25px; float: left; width: 49%;">
	                	<!-- table -->               
                    	<table id="tbl-arrival-error-info" style="border-style: none;">
                            <thead>
                            	<tr>
                                    <th colspan="2" style="background-color: #e6e6ff;"><b>도착 예정 시간 오차</b></th> 
                	...
                	<!-- /.row --> 
                	<!-- .row -->   
                	<div class="row" style="margin-bottom: 25px; float: right; width: 49%;">
	                	<!-- table -->               
                    	<table id="tbl-arrival-errorRate-info" style="border-style: none;">
                            <thead style="height: 25px">
                             	<tr>
                                    <th colspan="2" style="background-color: #e6e6ff;"><b>도착 예정 시간 오차율</b></th> 
                                    <th colspan="3" style="background-color: white;border-style: none"></th>
                                </tr>                               
                                <tr>
                                    <th rowspan="3">평가 대상</th>
